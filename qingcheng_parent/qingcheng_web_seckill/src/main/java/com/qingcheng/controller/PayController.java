    ...
    public Map createNative(String orderId){
        ...
        if(seckillOrder!=null){
            ...
            if("0".equals(seckillOrder.getStatus()) &&  "0".equals(seckillOrder.getStatus()) && username.equals(seckillOrder.getUserId())){
                return weixinPayService.createNative(seckillOrder.getId().toString(), (int) (seckillOrder.getMoney().floatValue()*100),"http://4l109b8921.wicp.vip/pay/notify.do",username);
            }else{
                return null;
            }
        }else{
